...
void Graphics::EndFrame()
{
	...
	if (FAILED(hr = pSwap->Present(1u, 0u)))
	{
		...
		{
			throw GFX_DEVICE_REOMOVED_EXCEPT(pDevice->GetDeviceRemovedReason());
		}
		else
		{
			throw GFX_EXCEPT(hr);
...
{
	return  "Sudal Graphics Exception";
}
...
{
	return "Sudal Graphics Exception [Device Removed] (DXGI_ERROR_DEVICE_REMOVED)";
}
...
{
	return "Sudal Graphics Info Exception";
}
